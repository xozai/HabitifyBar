...
Append `!` after the type for breaking changes: `feat!: drop support for macOS 14`

### Good PR title examples ✅

```
feat: add habit streak notifications
fix: correct journal date format sent to API
chore: upgrade dependencies to latest
feat!: rename API key storage from Keychain to SecureEnclave
...
Feature/new-filter       # branch name, not a commit message
